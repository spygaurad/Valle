...
class Handwriting_Model(nn.Module):
    ...
    def forward(self, batch_output):
        ...
        return txt2txt_dec_txt, img2img_dec_img, img2txt_dec_txt, txt2img_dec_img
...
class Handwriting(Task):
        ...
        for epoch in range(self.current_epoch, self.config.epoch + 1):
            ...
            with progressbar.ProgressBar(max_value=len(self.train_set)) as bar:
                ...
                for index, batch_output in enumerate(self.train_set):
                    ...
                    txt2txt_dec_txt, img2img_dec_img, img2txt_dec_txt, txt2img_dec_img = self.model(batch_output)
                    ...
                    loss = txt2txt_loss + img2img_loss + img2txt_loss + txt2img_loss
                    loss.backward()
            ...
            print("train_txt2txt_loss", np.average(total_txt2txt_loss))
            ...
            if epoch % self.config.model_eval_epoch == 0:
                ...
                self.exp_track.log_metric("train_txt2txt_loss", np.average(total_txt2txt_loss))
    ...
    def eval_model(self):
        ...
        self.exp_track.log_metric("val_txt2txt_loss", np.average(total_txt2txt_loss))
